...
namespace HouseStatusScraper.Scrapers
{
	class Remax : WebScraper
	{
		...
		public override void Init()
		{
			...
			this.Request("https://www.remax.com/realestatehomesforsale/20-plumwood-rd-dayton-oh-45409-gid600026562867.html", Parse);
			WebsiteName = "remax.com";
		}
		...
		public override void Parse(Response response)
		{
			...
			foreach (string line in lines)
			{
				...
				if (line.Contains("Request a showing"))
				{
