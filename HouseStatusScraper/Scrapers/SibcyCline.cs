...
namespace HouseStatusScraper.Scrapers
{
    class SibcyCline : WebScraper
    {
        ...
        public override void Init()
        {
            ...
            this.Request("https://www.sibcycline.com/Listing/DTON/722229/20-Plumwood-Rd-Dayton-OH-45409", Parse);
            WebsiteName = "sibcycline.com";
        }
        ...
        public override void Parse(Response response)
        {
            ...
            //Sibcycline doesn't have the active status on their page for actve listings. Set it to active if no status found
